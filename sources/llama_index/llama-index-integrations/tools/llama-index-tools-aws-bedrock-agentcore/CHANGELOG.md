...
- Add browser lifecycle methods (not exposed as agent tools): `list_browsers`, `create_browser`, `delete_browser`, `get_browser`
- Add code interpreter lifecycle methods (not exposed as agent tools): `list_code_interpreters`, `create_code_interpreter`, `delete_code_interpreter`, `get_code_interpreter`
...
- Browser tool count: 8 → 10, Code Interpreter tool count: 9 → 15
