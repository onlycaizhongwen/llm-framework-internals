...
class TestCodeInterpreterE2E:
    ...
    @pytest.mark.skipif(not ROLE_ARN, reason="AWS_AGENTCORE_ROLE_ARN not set")
    ...
    @pytest.mark.skipif(not ROLE_ARN, reason="AWS_AGENTCORE_ROLE_ARN not set")
    @pytest.mark.skipif(
        not SUBNET_IDS or not SG_IDS,
        reason="AWS_AGENTCORE_SUBNET_IDS and AWS_AGENTCORE_SG_IDS not set",
    )
